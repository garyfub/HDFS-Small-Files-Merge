...
gu_id,
starttime,
case when cast(entrance2_page_id as int) > 0 then entrance2_page_id else entrance_page_id end last_entrance_page_id,
...
case when cast(entrance2_page_id as int) > 0 then entrance2_starttime else entrance_starttime end last_entrance_timestamp,
