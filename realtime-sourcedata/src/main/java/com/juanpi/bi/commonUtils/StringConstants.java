...
public final class StringConstants {
	...
	//{ （左）花括号/大括号 (left|open) braces
	public static final String  left_braces = "{";
	
	//} （右）花括号/大括号 (right|close) braces
	public static final String  right_braces = "}";
	
	//[ （左）方括号/中括号 (left|open) brackets
	public static final String  left_brackets = "[";

	//] （右）方括号/中括号 (right|close) brackets
	public static final String  right_brackets = "]";
	
	//( （左）圆括号/小括号 (left|open) parentheses
	public static final String  left_parentheses = "(";

	//) （右）圆括号/小括号 (right|close) parentheses
