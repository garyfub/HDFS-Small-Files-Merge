...
import com.juanpi.bi.transformer.H5EventTransformer.BaseLog
import com.juanpi.bi.transformer.pageAndEventParser

/**
  * Created by dianmao on 2016/12/16.
  */
class TestH5transformer {
