...
# mb_pageinfo_hash2
hadoop fs -ls hdfs://nameservice1/user/hadoop/dw_realtime/reprod/mb_pageinfo_hash2
hadoop fs -ls hdfs://nameservice1/user/hadoop/dw_realtime/reprod/mb_pageinfo_hash2/date=2017-03-03/gu_hash=4/logs

# pc_events_hash3
hadoop fs -ls hdfs://nameservice1/user/hadoop/dw_realtime/reprod/pc_events_hash3
hadoop fs -ls hdfs://nameservice1/user/hadoop/dw_realtime/reprod/pc_events_hash3/date=22017-03-03/gu_hash=4/logs

# jp_hash3
hadoop fs -ls hdfs://nameservice1/user/hadoop/dw_realtime/reprod/jp_hash3
